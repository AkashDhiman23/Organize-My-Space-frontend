      ...
      <div className="pd-main-grid">
        <div className="pd-form">
          ...
          <div className="pd-buttons">
            {/* File input for uploading production images */}
           <input
  type="file"
  accept="image/*"
  multiple
  disabled={!canAddProductionImage || projectStatus === "Completed"}
  onChange={handleImageUpload}
  id="upload-production-images"
  style={{ display: "none" }}
/>
<label
  htmlFor="upload-production-images"
  className={`btn-dark ${
    !canAddProductionImage || projectStatus === "Completed" ? "disabled" : ""
  }`}
  style={{
    cursor:
      !canAddProductionImage || projectStatus === "Completed"
        ? "not-allowed"
        : "pointer",
  }}
>
  {projectStatus === "Completed"
    ? "Project Completed - Cannot Add Images"
    : canAddProductionImage
    ? productionImagesCount === 0
      ? "Add Production Image"
      : "Add Another Production Image"
    : "4 Production Images Max"}
</label>
        ...
        <div key={img.id} className="col">
          <div className="card h-100 shadow-sm border-0 rounded-3 p-2">
            ...
            <div className="card-body">
              <h6 className="card-title">Production Image {img.image_num}</h6>
              <div className="d-flex flex-column gap-2">
                <a href={img.file} target="_blank" rel="noreferrer" className="btn btn-outline-primary btn-sm">
                  <i className="bi bi-eye me-1" /> View
                </a>
                <a href={img.file} download className="btn btn-outline-secondary btn-sm">
        ...
        <div key={d.id} className="col">
          <div className="card h-100 shadow-sm border-0 rounded-3 p-2">
            ...
            <div className="card-body">
              ...
              <div className="d-flex flex-column gap-2">
                <a href={d.file} target="_blank" rel="noreferrer" className="btn btn-outline-primary btn-sm">
                  <i className="bi bi-eye me-1" /> View
                </a>
                <a href={d.file} download className="btn btn-outline-secondary btn-sm">
                  <i className="bi bi-download me-1" /> Download
                </a>
              </div>
            </div>
